    ...
    connect(args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _queryParams = {
                ...
                eager_eot_threshold: eagerEotThreshold != null
                    ? typeof eagerEotThreshold === "string"
                        ? eagerEotThreshold
                        : (0, json_js_1.toJson)(eagerEotThreshold)
                    : undefined,
                eot_threshold: eotThreshold != null
                    ? typeof eotThreshold === "string"
                        ? eotThreshold
                        : (0, json_js_1.toJson)(eotThreshold)
                    : undefined,
                eot_timeout_ms: eotTimeoutMs != null
            ...
            const socket = new core.ReconnectingWebSocket({
                url: core.url.join((_b = (yield core.Supplier.get(this._options.baseUrl))) !== null && _b !== void 0 ? _b : ((_c = (yield core.Supplier.get(this._options.environment))) !== null && _c !== void 0 ? _c : environments.DeepgramEnvironment.Production).production, "/v2/listen"),
